...
credit_edu = (credit_card.EDUCATION == 5) | (credit_card.EDUCATION == 6) | (credit_card.EDUCATION == 0)
credit_card.loc[credit_edu, 'EDUCATION'] = 4
...
credit_prepro.fit(np.array([1,2,3,4]).reshape(-1,1)) # EDUCATION
